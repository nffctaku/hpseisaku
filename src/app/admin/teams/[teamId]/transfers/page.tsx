  ...
  return (
    <div className="min-h-screen bg-[#0b1220] p-4 md:p-6">
      <div className="mx-auto max-w-4xl space-y-6">
        <div className="flex items-start justify-between gap-3">
          <div className="min-w-0">
            <h1 className="text-2xl font-bold text-white truncate sm:text-3xl">移籍管理</h1>
          </div>
        </div>

        <div>
          <details className="group rounded-xl border border-[#263149] bg-[#141d2e]">
            <summary
              className="cursor-pointer list-none [&::-webkit-details-marker]:hidden px-4 py-3"
              style={{ listStyle: "none" }}
            >
              <div className="flex items-center justify-between gap-3">
                <div className="font-semibold text-sm text-white">設定</div>
                <div className="inline-flex items-center gap-2 text-xs text-[#8b93a7]">
                  <span>{selectedSeason || "-"}</span>
                  <span> / </span>
                  <span>{currency}</span>
                  <span className="inline-flex h-4 w-4 items-center justify-center text-[#8b93a7] transition-transform group-open:rotate-180">
            ...
            <div className="px-4 pb-4 pt-1 space-y-3">
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 items-end">
                <div className="space-y-1">
                  <div className="text-xs text-[#8b93a7]">シーズン</div>
                  <Select
                  ...
                  >
                    <SelectTrigger className="w-full bg-[#101827] text-white border-[#263149]">
                ...
                <div className="space-y-1">
                  <div className="text-xs text-[#8b93a7]">通貨</div>
                ...
                <div className="space-y-1">
                  <div className="text-xs text-[#8b93a7]">公開</div>
                  <label className="flex items-center gap-2 rounded-md border border-[#263149] bg-[#101827] px-3 py-2 text-xs font-medium text-white whitespace-nowrap">
                    <Checkbox
      ...
      {selectedSeason ? (
        ...
        <div className="space-y-3 rounded-xl border border-[#263149] bg-[#141d2e] p-6">
          <p className="text-sm text-[#8b93a7]">シーズンを選択または追加してください。</p>
          <Button
            type="button"
            variant="outline"
            className="bg-[#101827] text-white border-[#263149] hover:bg-[#263149]"
