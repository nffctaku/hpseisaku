...
const LIMIT_TABLE: Record<LimitKey, Record<PlanTier, number>> = {
  ...
  players_per_team_per_season: { free: 30, pro: 30, officia: Number.POSITIVE_INFINITY },
  player_photos_per_team_per_season: { free: 20, pro: 30, officia: Number.POSITIVE_INFINITY },
